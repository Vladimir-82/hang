ANIMALS = 'кот ёжик собака корова лошадь тигр лев шакал пантера слон жираф носорог бегемот броненосец медведь лиса волк заяц кролик кобан рысь'.split()
CITYS='минск москва рига лондон париж токио мадрид лиссабон берлин прага варшава вильнюс таллин вашингтон оттава могилёв гомель гродно витебск брест логойск борисов'.split()
HANGMAN_PICS=["""
 +---+
     |
     |
...
while True:
    print('Начнем!')
    print()
    print('Попробуйте отгадать слово, или будете повешаны!!!')
    while category!='1' or category!='2':
        category = input('Выбирете категорию: 1 - животные, 2 - города мира:')
        if category=='1':
            WORDS = ANIMALS
            break
        elif category=='2':
            ...
            print('Вы ввели некорректную категорию!!!')
